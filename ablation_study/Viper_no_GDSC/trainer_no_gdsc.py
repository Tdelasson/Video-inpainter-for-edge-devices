...
from .viper_no_gdsc import ViperNoGDSC
...
def train(args, model, discriminator, train_loader, val_loader, mask_dataset, val_mask_dataset, human_mask_dataset,
    ...
    while current_iter < args.iterations:
        for data in train_loader:
            ...
            if current_iter % 500 == 0 and current_iter > 5000:
...
def main():
    ...
    model = ViperNoGDSC(in_channels=in_channels, base_channels=BASE_CHANNELS, num_layers=NUM_LAYERS).to(device)
